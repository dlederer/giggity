...
describe ConversationsController do
  ...
  describe "GET index" do
    it "assigns all conversations as @gigs" do
  ...
  describe "GET show" do
    it "assigns the requested conversation as @gig" do
      conversation = Conversation.create! valid_attributes
  ...
  describe "GET new" do
    it "assigns a new conversation as @gig" do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created conversation as @gig" do
        post :create, {:conversation => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved conversation as @gig" do
        # Trigger the behavior that occurs when invalid params are submitted
        Conversation.any_instance.stub(:save).and_return(false)
        post :create, {:conversation => { "booker_id" => "invalid value" }}, valid_session
        assigns(:conversation).should be_a_new(Conversation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested conversation" do
        ...
        Conversation.any_instance.should_receive(:update_attributes).with({ "booker_id" => "1" })
        put :update, {:id => conversation.to_param, :conversation => { "booker_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the conversation as @gig" do
        conversation = Conversation.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        Conversation.any_instance.stub(:save).and_return(false)
        put :update, {:id => conversation.to_param, :conversation => { "booker_id" => "invalid value" }}, valid_session
        assigns(:conversation).should eq(conversation)
      end
